...
CREATE INDEX "customers_restaurant_id_idx" ON "customers" USING btree ("restaurant_id");
CREATE INDEX "customers_email_idx" ON "customers" USING btree ("email");
CREATE INDEX "expenses_restaurant_id_idx" ON "expenses" USING btree ("restaurant_id");
...
CREATE INDEX "ingredients_restaurant_id_idx" ON "ingredients" USING btree ("restaurant_id");
CREATE INDEX "inventory_movements_restaurant_id_idx" ON "inventory_movements" USING btree ("restaurant_id");
CREATE INDEX "inventory_movements_ingredient_id_idx" ON "inventory_movements" USING btree ("ingredient_id");
CREATE INDEX "inventory_movements_type_idx" ON "inventory_movements" USING btree ("type");
CREATE UNIQUE INDEX "members_user_restaurant_idx" ON "members" USING btree ("user_id","restaurant_id");
...
CREATE INDEX "notifications_restaurant_id_idx" ON "notifications" USING btree ("restaurant_id");
...
CREATE INDEX "payments_restaurant_id_idx" ON "payments" USING btree ("restaurant_id");
...
CREATE INDEX "purchase_orders_restaurant_id_idx" ON "purchase_orders" USING btree ("restaurant_id");
CREATE INDEX "purchase_orders_status_idx" ON "purchase_orders" USING btree ("status");
CREATE INDEX "reservations_restaurant_id_idx" ON "reservations" USING btree ("restaurant_id");
